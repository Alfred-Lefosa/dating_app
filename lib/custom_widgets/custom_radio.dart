...
class _CustomRadioState<T, U> extends State<CustomRadio<T, U>>
  ...
  @override
  void initState() { // initialize the state of the widget, animations, and animations controller
    super.initState();
  ...
  @override
  void dispose() {
    _controller?.dispose(); // dispose the controller when it is no longer needed
    super.dispose();
  }
