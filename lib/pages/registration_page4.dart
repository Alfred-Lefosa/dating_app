...
class RegistrationPage4 extends StatefulWidget {
  RegistrationPage4({Key key, this.title}) : super(key: key);
  ...
  @override
  _RegistrationPage4State createState() => _RegistrationPage4State();
}
            ...
            child: Column(
              ...
              children: <Widget>[
                CustomCheckBox(
                  ...
                  isChecked: user.getPreferenceLookingFor["Short-term Dating"] ==
                      "Short-term Dating",
                  onChanged: (value) {
                    setState(() {
                      user.setPreferenceLookingFor("Short-term Dating", value);
                    });
                  },
                ),
                CustomCheckBox(
                  ...
                  isChecked: user.getPreferenceLookingFor["Long-term Relationship"] ==
                      "Long-term Relationship",
                  onChanged: (value) {
                    setState(() {
                      user.setPreferenceLookingFor("Long-term Relationship", value);
                    });
                  },
                ),
                CustomCheckBox(
                  ...
                  isChecked: user.getPreferenceLookingFor["Open to Anything"] ==
                      'Open to Anything',
                  onChanged: (value) {
                    user.setPreferenceLookingFor("Open to Anything", value);
                  },
                ),
                Row(
                  children: <Widget>[
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      CustomRadioBtn(
                        value: 'Single',
                        label: 'Single',
                        groupValue: user.getPreferenceMaritalStatus,
                        onChanged: (value) {
                          setState(() {
                            user.setPreferenceMaritalStatus(value);
                          });
                        },
                      ),
                      CustomRadioBtn(
